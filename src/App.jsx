...
function App() {
  ...
  return (
    <div className='font-Montserrat'>
      <nav className='w-full h-14 hidden bg-white lg:flex p-4 justify-between'>
        <div className='h-auto w-auto'>
          <p className='text-xl text-primary font-black'>Platzi Travel</p>
        </div>
        <div className='flex space-x-8'>
          <a className='font-bold text-md text-primary' href='#home'>Inicio</a>
          <a className='font-bold text-md text-primary' href='#home'>Recomendados</a>
          <a className='font-bold text-md text-primary' href='#home'>Rentas</a>
          <a className='font-bold text-md text-primary' href='#home'>FAQS</a>
          <a className='font-bold text-md text-primary' href='#home'>Sobre nosotros</a>
        </div>
      ...
      <section className='w-full h-screen'>
        <div id='home' className='w-full h-3/4'>
          <div className='w-full h-3/4'>
            <div className='w-full h-full flex flex-col absolute space-y-96 py-4 items-center lg:space-y-0 lg:items-start lg:pt-20 lg:justify-start'>
              <input className='p-3 rounded-full transition duration-300 focus:ring-2 focus:w-11/12 lg:hidden' placeholder='San Francisco' type="search" name="" id="" />
              ...
              <button className='w-36 rounded-full p-4 bg-white text-primary transition transition-all duration-500 ease-in-out hover:bg-primary hover:text-white transform hover:-translate-y-1 hover:scale-110 lg:ml-16'>
                Explorar
              </button>
            </div>
            <div className='w-full h-full lg:h-96 lg:bg-sanFranciscoDesktop lg:bg-cover lg:bg-center'>
              <img className='lg:hidden' src='../img/sanFrancisco.jpg' />
            </div>
          </div>
        </div>
        <div className='p-10'  id='recomendadas'>
          ...
          <div className='w-auto h-72 items-center mt-6 overflow-x-auto overscroll-x-contain flex space-x-6'>
            <div className='Card'>
              ...
              <div className='w-full h-2/5 bg-secondary rounded-b-lg'>
                ...
                <p className='px-4 text-white text-md'>Paisajes increibles</p>
              </div>
            </div>
            <div className='Card'>
              <div className='w-full h-3/5 rounded-t-lg bg-new_york bg-cover'></div>
              <div className='w-full h-2/5 bg-white rounded-b-lg'>
                <p className='px-4 py-2 text-tertiary font-bold text-xl'>Ney York</p>
                <p className='px-4 text-tertiary text-md'>La gran manzana</p>
              </div>
            </div>
            <div className='Card'>
              <div className='w-full h-3/5 rounded-t-lg bg-sydney bg-cover'></div>
              <div className='w-full h-2/5 bg-secondary rounded-b-lg'>
                <p className='px-4 py-2 text-white font-bold text-xl'>Sydney</p>
                <p className='px-4 text-white text-md'>Paisajes increibles</p>
              </div>
            </div>
            <div className='Card'>
              ...
              <div className='w-full h-2/5 bg-white rounded-b-lg'>
                <p className='px-4 py-2 text-tertiary font-bold text-xl'>Seattle</p>
                <p className='px-4 text-tertiary text-md'>La gran manzana</p>
              </div>
            </div>
            <div className='Card'>
              ...
              <div className='w-full h-2/5 bg-secondary rounded-b-lg'>
                <p className='px-4 py-2 text-white font-bold text-xl'>Miami</p>
                <p className='px-4 text-white text-md'>Paisajes increibles</p>
              </div>
            </div>
            <div className='Card'>
              ...
              <div className='w-full h-2/5 bg-white rounded-b-lg'>
                <p className='px-4 py-2 text-tertiary font-bold text-xl'>Switzerland</p>
                <p className='px-4 text-tertiary text-md'>La gran manzana</p>
              </div>
            </div>
        ...
        <div className='px-2 h-auto w-full' id='rentas_destacadas'>
          <p className='text-xl pb-6 mt-4 text-primary font-semibold'>Rentas Destacadas</p>
        ...
        <div className='w-full h-auto' id="faqs">
          <div className='w-full h-full px-6 flex flex-col space-y-2'>
            <p className='text-3xl text-primary font-semibold mt-4'>FAQS</p>
            <div>
              <p className='text-xl font-medium text-primary'>Política de Cancelación</p>
            ...
            <div>
              <p className='text-xl font-medium text-primary'>Método de Pago</p>
